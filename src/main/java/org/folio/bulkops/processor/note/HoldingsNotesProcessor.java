...
public class HoldingsNotesProcessor extends AbstractNoteProcessor {
  ...
  public HoldingsNotesProcessor(HoldingsReferenceService holdingsReferenceService, NoteTableUpdater noteTableUpdater) {
  ...
  public List<String> getNoteTypeNames() {
    return holdingsReferenceService.getAllHoldingsNoteTypes().stream()
