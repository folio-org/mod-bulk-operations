...
public class PermissionsValidator {
  ...
  private static final String BULK_EDIT_INVENTORY_WRITE_PERMISSION = "bulk-operations.item.inventory.put";
  private static final String BULK_EDIT_USERS_WRITE_PERMISSION = "bulk-operations.item.users.put";
