...
public class FqmKeys {
  ...
  public static final String FQM_ITEM_MATERIAL_TYPE_ID_KEY = "material_type.id";
  public static final String FQM_ITEM_MATERIAL_TYPE_NAME_KEY = "material_type.name";
