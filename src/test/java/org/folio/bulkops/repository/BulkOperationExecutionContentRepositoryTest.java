...
class BulkOperationExecutionContentRepositoryTest extends BaseTest {
  @Autowired private BulkOperationExecutionContentRepository repository;
  ...
  @Autowired private BulkOperationExecutionChunkRepository bulkOperationExecutionChunkRepository;
  ...
  private BulkOperationExecutionContent createEntity() {
    ...
    var bulkOperationExecutionChunk =
        bulkOperationExecutionChunkRepository.save(
            BulkOperationExecutionChunk.builder()
