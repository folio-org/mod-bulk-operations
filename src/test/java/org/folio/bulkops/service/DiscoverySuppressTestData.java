...
public enum DiscoverySuppressTestData {
  SET_TRUE_HOLDINGS_SUPPRESSED_ITEMS_SUPPRESSED(
      SET_TO_TRUE, true, true, true, true, 0, MSG_NO_CHANGE_REQUIRED),
  SET_FALSE_HOLDINGS_SUPPRESSED_ITEMS_SUPPRESSED(SET_TO_FALSE, true, false, true, true, 2, null),
  SET_TRUE_HOLDINGS_UNSUPPRESSED_ITEMS_UNSUPPRESSED(
      SET_TO_TRUE, false, true, false, false, 2, null),
  SET_FALSE_HOLDINGS_UNSUPPRESSED_ITEMS_UNSUPPRESSED(
      SET_TO_FALSE, false, false, false, false, 0, MSG_NO_CHANGE_REQUIRED),
  SET_TRUE_HOLDINGS_SUPPRESSED_ONE_ITEM_SUPPRESSED(
      SET_TO_TRUE,
      true,
      true,
      true,
  ...
  SET_FALSE_HOLDINGS_SUPPRESSED_ONE_ITEM_SUPPRESSED(
      SET_TO_FALSE, true, false, true, false, 1, null),
  SET_TRUE_HOLDINGS_UNSUPPRESSED_ONE_ITEM_UNSUPPRESSED(
      SET_TO_TRUE, false, true, true, false, 1, null),
  SET_FALSE_HOLDINGS_UNSUPPRESSED_ONE_ITEM_UNSUPPRESSED(
      SET_TO_FALSE,
      false,
      false,
      true,
