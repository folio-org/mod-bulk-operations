  ...
  private void initMocks() {
    ...
    when(damagedStatusClient.getByQuery("name==\"@damaged/status\"")).thenReturn(new DamagedStatusCollection()
      .withItemDamageStatuses(List.of(new DamagedStatus()
        ...
        .withName("@damaged/status")
        .withSource("-source-"))));
    when(itemNoteTypeClient.getByQuery("name==\"Item@Note@NameX\"", 1)).thenReturn(new NoteTypeCollection().withItemNoteTypes(List.of(new NoteType().withId("1dde7141-ec8a-4dae-9825-49ce14c728e7").withName("Item@Note@NameX"))));
    when(itemNoteTypeClient.getByQuery("name==\"Item@Note@Name_2\"", 1)).thenReturn(new NoteTypeCollection().withItemNoteTypes(List.of(new NoteType().withId("c3a539b9-9576-4e3a-b6de-d910200b2919").withName("Item@Note@Name_2"))));
    ...
    when(callNumberTypeClient.getByQuery("name==\"Call-number@type_holding\"")).thenReturn(new CallNumberTypeCollection().withCallNumberTypes(List.of(new CallNumberType()
      ...
      .withName("Call-number@type_holding")
      .withSource("s@urce-holding"))));
    when(holdingsNoteTypeClient.getByQuery("name==\"Holding#Type#Name\"", 1)).thenReturn(new HoldingsNoteTypeCollection().withHoldingsNoteTypes(List.of(new HoldingsNoteType().withId("88914775-f677-4759-b57b-1a33b90b24e0").withName("Holding#Type#Name"))));
