...
class ProfileServiceTest extends BaseTest {
  ...
  void testDeleteProfile_lockedProfile_throwsProfileLockedException() {
    try (var context = new FolioExecutionContextSetter(folioExecutionContext)) {
      ...
      doThrow(
              new ProfileLockedException(
                  "Cannot delete a locked profile without proper permission"))
  ...
  void testCreateProfile() {
    try (var context = new FolioExecutionContextSetter(folioExecutionContext)) {
      ...
      ReflectionTestUtils.setField(profileService, "folioExecutionContext", folioExecutionContext);
