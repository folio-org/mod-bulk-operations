...
class MarcToUnifiedTableRowMapperTest extends BaseTest {
  ...
  void processRecordWithElectronicAccessTest() {
    ...
    assertThat(rowData.getFirst()).isEqualTo("URL relationship;URI;Link text;Material specified;URL public note\n" +
  ...
  void processRecordWithElectronicAccessAndRepeatableFieldsTest() {
    ...
    assertThat(rowData.getFirst()).isEqualTo("Related resource%s;url%s;text text2%s;material%s;public note public note2"
  ...
  void processRecordWithElectronicAccessIfSubfieldIsEmptyTest() {
    ...
    assertThat(rowData.getFirst()).isEqualTo(("Related resource\u001f;-\u001f;text\u001f;material\u001f;public note"));
  }
