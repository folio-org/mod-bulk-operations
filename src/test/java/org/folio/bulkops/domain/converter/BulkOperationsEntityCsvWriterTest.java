  ...
  void shouldSplitCirculationNotesForItem() {
    ...
    var item = Item.builder()
            ...
            .circulationNotes(List.of(
                    CirculationNote.builder().noteType(IN).note("Check in note 1")
                            .staffOnly(true).build(),
                    CirculationNote.builder().noteType(OUT).note("Check out note 1")
                            .staffOnly(true).build(),
                    CirculationNote.builder().noteType(OUT).note("Check out note 2")
