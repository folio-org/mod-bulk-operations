...
//    assertThat(dto.getCreatedDate()).isEqualTo(profile.getCreatedDate());
...
//    assertThat(dto.getUpdatedDate()).isEqualTo(profile.getUpdatedDate());
  ...
  void shouldMapProfileToSummaryDto() {
    ...
    ProfileSummaryDTO summary = profileMapper.toSummmaryDTO(profile);
...
//    assertThat(summary.getCreatedDate()).isEqualTo(profile.getCreatedDate());
...
//    assertThat(summary.getUpdatedDate()).isEqualTo(profile.getUpdatedDate());
