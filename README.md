...
### FQM integration
The data fetching component from FQM for Query and Identifiers approaches is configured using two parameters: FQM_MAX_CHUNK_SIZE - the maximum 
...
| FQM\_QUERY\_APPROACH       | true                            | Approach to use with query: false if identifiers flow, otherwise FQM flow for both Query and Identifiers approaches |
